...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if ($\color{lightskyblue}{\textsf{Latasha.strengths.includes(}}$ $\color{#DC965A}{\textsf{"critical thinker"}}$) && $\color{lightskyblue}{\textsf{Latasha.skills.includes(}}$ $\color{#DC965A}{\textsf{"data visualization"}}$ ) && $\color{lightskyblue}{\textsf{Latasha.languages}}$ == $\color{#DC965A}{\textsf{"python"}}$) { <br><br>
